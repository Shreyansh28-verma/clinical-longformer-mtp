...
# }
RUNS = {
    # Three-class model — one entry per dataset
    "three_class_2021_wholeq": {
        "run_file": os.path.join(os.path.dirname(__file__), "output", "predictions_three_class", "2021_wholeq_three_class_run.txt"),
        "dataset_id": "clinicaltrials/2021/trec-ct-2021",
    },
    "three_class_2021_wholeq_rm3": {
        "run_file": os.path.join(os.path.dirname(__file__), "output", "predictions_three_class", "2021_wholeq_rm3_three_class_run.txt"),
        "dataset_id": "clinicaltrials/2021/trec-ct-2021",
    },
    "three_class_2022_wholeq": {
        "run_file": os.path.join(os.path.dirname(__file__), "output", "predictions_three_class", "2022_wholeq_three_class_run.txt"),
        "qrels_file": os.path.join(os.path.dirname(os.path.abspath(__file__)), "qrels2022.txt"),
    },
    "three_class_2022_wholeq_rm3": {
        "run_file": os.path.join(os.path.dirname(__file__), "output", "predictions_three_class", "2022_wholeq_rm3_three_class_run.txt"),
        "qrels_file": os.path.join(os.path.dirname(os.path.abspath(__file__)), "qrels2022.txt"),
    },
    # Structural-attention model — one entry per dataset
    "structural_2021_wholeq": {
        "run_file": os.path.join(os.path.dirname(__file__), "output", "predictions_structural", "2021_wholeq_structural_run.txt"),
        "dataset_id": "clinicaltrials/2021/trec-ct-2021",
    },
    "structural_2021_wholeq_rm3": {
        "run_file": os.path.join(os.path.dirname(__file__), "output", "predictions_structural", "2021_wholeq_rm3_structural_run.txt"),
        "dataset_id": "clinicaltrials/2021/trec-ct-2021",
    },
    "structural_2022_wholeq": {
        "run_file": os.path.join(os.path.dirname(__file__), "output", "predictions_structural", "2022_wholeq_structural_run.txt"),
        "qrels_file": os.path.join(os.path.dirname(os.path.abspath(__file__)), "qrels2022.txt"),
    },
    "structural_2022_wholeq_rm3": {
        "run_file": os.path.join(os.path.dirname(__file__), "output", "predictions_structural", "2022_wholeq_rm3_structural_run.txt"),
        "qrels_file": os.path.join(os.path.dirname(os.path.abspath(__file__)), "qrels2022.txt"),
    },
}
